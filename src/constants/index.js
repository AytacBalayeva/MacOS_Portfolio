  ...
  children: [
    // ▶ Project 1
    {
      ...
      children: [
        ...
        {
          id: 4,
          name: "product-page.png",
          icon: "/images/image.png",
          kind: "file",
          fileType: "img",
          position: "top-52 right-100",
          imageUrl: "/images/project-1-products.png",
        },
        {
          id: 5,
          name: "product-details-page.png",
          icon: "/images/image.png",
          kind: "file",
          fileType: "img",
          position: "top-52 right-20",
          imageUrl: "/images/project-1-product-details.png",
        },
      ],
    },
    ...
    // ▶ Project 2
    {
      ...
      children: [
        ...
        {
          id: 3,
          name: "food-deatils-page.png",
          icon: "/images/image.png",
          kind: "file",
          fileType: "img",
          position: "top-40 left-60",
          imageUrl: "/images/project-2-product-details.png",
        },
        {
          id: 4,
          name: "cart-page.png",
          ...
          imageUrl: "/images/project-2-cart.png",
        },
      ],
    },
